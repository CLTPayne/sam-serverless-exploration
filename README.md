# sam-serverless-exploration

This is a sample template for sam-serverless-exploration - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name sam-serverless-exploration \
...
```bash
sam logs -n HelloWorldFunction --stack-name sam-serverless-exploration --tail
```
...
```bash
aws cloudformation delete-stack --stack-name sam-serverless-exploration
```
